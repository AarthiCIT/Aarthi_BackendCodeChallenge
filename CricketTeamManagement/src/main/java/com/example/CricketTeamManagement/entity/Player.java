...
public class Player {
    ...
    public Player(Long playerId, String playerName, int jerseyNumber, String role, int totalMatches, String teamName, String countryStateName, String description) {
